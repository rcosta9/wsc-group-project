...
use VendorFPF\Monolog\Handler\AbstractProcessingHandler;
use VendorFPF\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \VendorFPF\Monolog\Logger::getLevelName($level);
    }

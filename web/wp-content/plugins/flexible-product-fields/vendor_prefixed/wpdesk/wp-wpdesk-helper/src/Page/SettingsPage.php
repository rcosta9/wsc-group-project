 ...
 */
class SettingsPage implements \VendorFPF\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Settings', 'flexible-product-fields'), \__('Settings', 'flexible-product-fields'), 'manage_options', 'wpdesk-helper-settings', function () {
    ...
    private function handle_render_wpdesk_helper_settings()
    {
        ...
        <div class="wrap">
            <h1><?php 
        \_e('WP Desk Helper Settings', 'flexible-product-fields');
        ?></h1>

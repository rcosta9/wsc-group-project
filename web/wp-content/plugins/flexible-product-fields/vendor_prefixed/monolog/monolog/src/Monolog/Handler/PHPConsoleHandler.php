...
use VendorFPF\PhpConsole\Handler;
...
class PHPConsoleHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @throws Exception
     */
    public function __construct(array $options = array(), \VendorFPF\PhpConsole\Connector $connector = null, $level = \VendorFPF\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    private function initConnector(\VendorFPF\PhpConsole\Connector $connector = null)
    {
        if (!$connector) {

 ...
 */
class SlackbotHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \VendorFPF\Monolog\Logger::CRITICAL, $bubble = \true)
    {

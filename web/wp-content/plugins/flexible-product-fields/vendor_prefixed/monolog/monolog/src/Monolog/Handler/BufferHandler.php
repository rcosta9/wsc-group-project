 ...
 */
class BufferHandler extends \VendorFPF\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\VendorFPF\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \VendorFPF\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {

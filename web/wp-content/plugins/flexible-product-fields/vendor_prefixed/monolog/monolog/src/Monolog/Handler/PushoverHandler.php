...
class PushoverHandler extends \VendorFPF\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct($token, $users, $title = null, $level = \VendorFPF\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \VendorFPF\Monolog\Logger::CRITICAL, $emergencyLevel = \VendorFPF\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
